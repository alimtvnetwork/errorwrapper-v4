...
func Test_Errint_Results_Basics(t *testing.T) {
	Convey("Nil receiver", t, func() {
		var r *errint.Results
	...
	Convey("Empty slice", t, func() {
		r := &errint.Results{Values: []int{}, ErrorWrapper: nil}
		So(r.IsEmpty(), ShouldBeTrue)
		So(r.HasAnyItem(), ShouldBeFalse)
		So(r.Length(), ShouldEqual, 0)
	})
	...
	Convey("Non-empty slice without error", t, func() {
		r := &errint.Results{Values: []int{1, 2, 3}, ErrorWrapper: nil}
...
func Test_Errint_Results_JSON(t *testing.T) {
