...
func Test_MoreCoverage_Refs(t *testing.T) {
	Convey("Refs creator family", t, func() {
		...
		So(errnew.Refs.OnlyOne(errtype.IO, "k", "v"), ShouldNotBeNil)
		So(errnew.Refs.OnlyOneUsingStackSkip(0, errtype.IO, "k", "v"), ShouldNotBeNil)
...
func Test_MoreCoverage_Ref(t *testing.T) {
	Convey("Ref creator family (subset)", t, func() {
		...
		So(errnew.Ref.ErrorWithMessageDefault(errtype.IO, err, "msg", "v"), ShouldNotBeNil)
		So(errnew.Ref.Default(errtype.IO, "v"), ShouldNotBeNil)
