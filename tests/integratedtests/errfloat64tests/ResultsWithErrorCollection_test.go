...
func Test_ErrFloat64_ResultsWithErrorCollection_Basics(t *testing.T) {
	Convey("Nil receiver", t, func() {
		var r *errfloat64.ResultsWithErrorCollection
	...
	Convey("Non-empty without error", t, func() {
		r := &errfloat64.ResultsWithErrorCollection{
		...
		So(r.SafeValues(), ShouldResemble, []float64{1.1, 2.2})
	})
