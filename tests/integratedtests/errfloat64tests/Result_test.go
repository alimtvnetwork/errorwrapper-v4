...
func Test_ErrFloat64_Result_Basics(t *testing.T) {
	Convey("Nil receiver", t, func() {
		var r *errfloat64.Result
	...
	Convey("Zero value without error", t, func() {
		r := &errfloat64.Result{Value: 0, ErrorWrapper: nil}
		So(r.IsEmpty(), ShouldBeTrue)
		So(r.HasIssuesOrEmpty(), ShouldBeTrue)
	})

	Convey("Positive value without error", t, func() {
		r := &errfloat64.Result{Value: 3.14159, ErrorWrapper: nil}
	...
	Convey("Value with error", t, func() {
		...
		r := &errfloat64.Result{Value: 1.5, ErrorWrapper: w}
	...
	Convey("ValidRange checks", t, func() {
		r := &errfloat64.Result{Value: 5.5, ErrorWrapper: nil}
...
func Test_ErrFloat64_Result_JSON(t *testing.T) {
	Convey("Json round-trip", t, func() {
		r := &errfloat64.Result{Value: 2.71828, ErrorWrapper: nil}
		j := r.Json()
